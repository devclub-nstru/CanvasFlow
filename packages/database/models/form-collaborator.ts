import { pgTable, uuid, varchar, timestamp, text, index, uniqueIndex, pgEnum } from 'drizzle-orm/pg-core'
import { formsTable } from './form'
import { usersTable } from './auth'

export const collaboratorRoleEnum = pgEnum("collaborator_role", ["viewer", "editor"])

export const formCollaboratorsTable = pgTable("form_collaborators", {
    ...
    formUserUniqIdx: uniqueIndex("form_collaborators_form_user_uniq_idx").on(table.formId, table.userId),
}))
