      ...
      <section className="flex h-full min-h-0 w-full flex-col justify-between p-3 sm:p-5 select-none relative">
        ...
        <div className="w-full flex flex-col items-center gap-1">
          <textarea
            ...
            rows={qLength > 35 ? 2 : 1}
            className={`w-full max-w-5xl resize-none overflow-hidden text-center rounded-2xl border-2 border-transparent bg-transparent px-3 py-1 font-medium leading-[1.15] tracking-[-0.04em] break-words text-neutral-900 outline-none transition hover:border-(--cf-orange)/30 focus:border-(--cf-orange) ${
