      ...
      <div className="mx-auto w-full max-w-[1600px] border-x border-[color:var(--cf-orange)] flex flex-col relative">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 p-8 lg:p-12 border-b border-[color:var(--cf-orange)]">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link href="/dashboard/pricing" className="text-sm font-semibold hover:translate-x-1 transition-transform inline-block w-fit">Pricing</Link>
          </div>

          <div className="flex flex-col gap-3">
            <h4 className="text-xs font-bold uppercase tracking-widest mb-2 opacity-60">Protocol</h4>
            <Link href="/privacy" className="text-sm font-semibold hover:translate-x-1 transition-transform inline-block w-fit">Privacy Policy</Link>
            <Link href="/terms" className="text-sm font-semibold hover:translate-x-1 transition-transform inline-block w-fit">Terms of Service</Link>
            <Link href="/security" className="text-sm font-semibold hover:translate-x-1 transition-transform inline-block w-fit">Security</Link>
          </div>

          <div className="flex flex-col gap-3">
            <h4 className="text-xs font-bold uppercase tracking-widest mb-2 opacity-60">Social</h4>
            <a href="https://twitter.com/canvasflow" target="_blank" rel="noopener noreferrer" className="text-sm font-semibold hover:translate-x-1 transition-transform inline-block w-fit">Twitter</a>
            <a href="https://github.com/canvasflow" target="_blank" rel="noopener noreferrer" className="text-sm font-semibold hover:translate-x-1 transition-transform inline-block w-fit">GitHub</a>
            <a href="https://discord.gg/canvasflow" target="_blank" rel="noopener noreferrer" className="text-sm font-semibold hover:translate-x-1 transition-transform inline-block w-fit">Discord</a>
          </div>
        </div>
